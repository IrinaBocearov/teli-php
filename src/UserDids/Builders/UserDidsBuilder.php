...
class UserDidsBuilder implements UserDidsBuilderInterface{
    ...
    public function remove($did_id = null, $did_number = null)
    {
    ...
    public function enableCNAM($did_id = null, $did_number = null)
    {
        return $this->httpClient->make('GET', 'https://apiv1.teleapi.net/user/dids/cnam/enable', [
			'did_id' => $did_id,
			'did_number' => $did_number
		]);
    }

    public function disableCNAM($did_id = null, $did_number = null)
    {
        return $this->httpClient->make('GET', 'https://apiv1.teleapi.net/user/dids/cnam/disable', [
			'did_id' => $did_id,
			'did_number' => $did_number
		]);
    }
