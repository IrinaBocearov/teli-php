...
class LnpBuilder implements LnpBuilderInterface{
    ...
    {
        return $this->httpClient->make('GET', 'https://apiv1.teleapi.net/lnp/check/portable/bulk',[
            'numbers'=> $numbers
        ]);
    }
    ...
    public function requestCSVList($request_id){
        return $this->httpClient->make('GET','https://apiv1.teleapi.net/lnp/request/csv', [
			'request_id'=> $request_id
		]);
    }
}