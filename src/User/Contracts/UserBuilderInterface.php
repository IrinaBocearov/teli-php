...
interface UserBuilderInterface{
	...
	/**
	 * Requests a list of usage report requests
	 * @param $payload {Object} status, optional
	 * @return mixed
	 */
	public function listUsageReports($payload);

	/**
	 * Initiates a request to build a usage report for the provided start and end date
	 * @param $payload {Object} Time periods
	 * @return mixed
	 */
	...
	/**
	 * Downloads a CSV file of the accounts usage data, including child accounts
	 * @param $payload {Object} request ID
	 * @return mixed
	 */
